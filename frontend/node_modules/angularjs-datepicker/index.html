...
<body>
  ...
  <div class="col6 offset-left2">
    <div class="col3">
      <div datepicker datepicker-class="test-custom-class" date-typer="true" date-min-limit="2016/02/28" date-max-limit="2016/03/25" date-typer="true">
...
<script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/angularjs/1.4.5/angular-route.min.js"></script>
